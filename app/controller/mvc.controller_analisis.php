<?php
session_start();
require 'app/model/analisis.class.php';

class mvc_controller_analisis
{   
  ...
  public function Grafico($consulta, $id_pre)
  {
      $unAnalisis =  new analisis(); 
      $respuestas = $unAnalisis->consultarGraficos($consulta);   
