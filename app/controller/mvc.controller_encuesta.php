...
public function consultar_preguntas_ubicacion($sql){
  $unaEncuesta =  new encuesta(); 
  $preguntas = $unaEncuesta->consultarPreguntasUbicacion($sql);  
...
public function cargarComboModuloEncuestaVer($id_encuesta){
  ...
  public function editarEncuesta($id_user, $editar)
  {
      $unaEncuesta =  new encuesta();
      $activado = $unaEncuesta->editarEncuestas($id_user, $editar); 
 ...
 public function ListadoPines($sql_listado, $id_consulta, $id_universidad, $id_facultad, $id_programa)
  {
      ...
      $_SESSION['codigos'] = $codigos;     
      //print_r($codigos);
      $uvsf =0; $uvme = 0; $puj = 0; $usc = 0;
      $respondidas_sf = 0; $respondidas_me = 0; $respondidas_puj = 0; $respondidas_usc = 0;
      $no_respondidas_sf = 0; $no_respondidas_me = 0; $no_respondidas_puj = 0; $no_respondidas_usc = 0;
      $sin_responder_sf = 0; $sin_responder_me = 0; $sin_responder_puj = 0; $sin_responder_usc = 0;
