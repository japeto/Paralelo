...
<html>
<head>
  <title>Crear Modulo - Modulo Encuestas</title>
    ...
    <div class="col-lg-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">     
          Ingrese el nombre del primer m&oacute;dulo para la Encuesta: <strong><?php echo $_SESSION['nombre_encuesta'];?></strong>
        </div>
        <br>
        <div class="panel-body">
          <form action="../../../../../indice_encuestas.php" method="POST" id="addmodform">
            <!-- <form method="POST" id="addmodform"> -->
            <div><input type="hidden" id="id_en" name="id_encuesta" value='<?php echo $_SESSION['id_encuesta'];?>'></div>
            <div><input type="hidden" id="flag" name="bandera" value='adicionar'></div>
            <input type="text" id="nom" name="nombre_modulo" placeholder="Introduce el nombre del modulo" class="form-control" tabindex="1"/>
            <br>
            <div><center><button type="submit" id="adicion" class="btn btn-primary" tabindex="2"><span class="glyphicon glyphicon-circle-arrow-right"></span> Continuar</button></center></div>    
          </div>
        </form>
      </div>
    </div>
