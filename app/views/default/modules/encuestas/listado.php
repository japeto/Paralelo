...
<html>
<head>
  <title>Cargar Encuesta - Modulo Encuestas</title>
...
<div id="page-wrapper">
  ...
  <!-- <div class="jumbotron">
    <form><input type="hidden" id="id_encuesta" value="<?php //echo $_GET['id_encuesta'];?>"/></form>
      <h2>
          Bienvenido al M&oacute;dulo Encuestas
      </h2>
      <br>
      <h4>En este modulo el usuario puede conocer el sistema de la aplicaci&oacute;n y todos las opciones a las que tiene acceso
      </h4>
    </div> -->
    <div class="row">
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form><input type="hidden" id="id_usuario" value="<?php echo $_SESSION['usuario'];?>"/></form>
            <div class="tablita">
              <table id="listado" class="table table-condensed"></table>
            </div>
          </div>
        </div>
      </div>
