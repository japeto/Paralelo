    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="../../../../../indice_encuestas.php" method="POST">
            ...
            <br>
            <br> 
            <div><center><button type="submit" class="btn btn-success  boton pull-right" tabindex="3"><i class="fa  fa-refresh fa-fw"></i> Actualizar</button></center></div>
          </form>
        </div>
    </div>
    </div>
