...
<html>
<head>
  <title>Cargar Encuesta <?php echo $_GET['nombre'];?>- Modulo Encuestas</title>
  ...
  <script type="text/javascript" src="../../js/encuesta_cargar.js" ></script>
...
<div id="page-wrapper">
  <div class="row">
    ...
    <?php endif;?> 
    <form>
      <input type="hidden" id="id_encuesta" value="<?php echo $_GET['id_encuesta'];?>"/>
      <input type="hidden" id="id_modulo_actual" value="<?php echo $_GET['id_modulo'];?>"/>
      <input type="hidden" id="cantidad_total_modulos" />
    </form>

    <div class="tablita" id="contenedor"></div> 
  </div>
</div>
</div>
