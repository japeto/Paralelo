...
<html>
<head>
  <title>Editar - Modulo Encuestas</title>
...
<script type="text/javascript" src="../../js/encuestas_editar.js" ></script>                
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form name="formname" action="../../../../../indice_encuestas.php" method="POST">
            ...
            <input type="hidden" id="id_encuesta" name="id_encuesta_editar">
            <input type="hidden" id="estate" name="estado">
            <input type="hidden" id="flag" name="bandera" value='editar'> 
            <div>
              <select class="selectpicker form-control" id="encuesta_editable" data-width="" data-live-search="true" data-style="btn btn-primary" data-size="5" tabindex="1">                                                            
                <option value="0">Seleccione la Encuesta a editar</option>
              </select>
            </div>
            <br>
            <div id='title'>Editar T&iacute;tulo<input type="text" class='form-control' id="titulo_encuesta_editar" name="nombre_encuesta_a_editar" tabindex="2"></div>
            <br>
            <div id='title1'>Editar Consentimiento</div>
            <br>
            <div id='title2'><textarea id="consentimiento_info" class="form-control" name="consentimiento_encuesta_editar" tabindex="3"></textarea></div>
            <br>                                     
            <div><center><button type="submit" class="btn btn-primary boton" tabindex="4"/><span class="glyphicon glyphicon-circle-arrow-right"></span>  Continuar</button> </center></div>
          </form>
        </div>              
      </div>
    </div>
