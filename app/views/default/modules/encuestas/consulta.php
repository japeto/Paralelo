...
<head>
  ...
  <script type="text/javascript" src="../../js/encuestas_consultar.js" ></script>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
         <form>
          ...
          <br>
          <div>
            <select class="selectpicker form-control"  id="id_consulta" data-width="" data-live-search="true" data-style="btn btn-primary" data-size="5" tabindex="2">
              <option value="0">Seleccione el estado de la encuesta</option>
              <option value="1">Encuestas en Edici&oacute;n</option>
              <option value="2">Encuestas Activas</option>
              <option value="3">Encuestas Desactivadas</option>
              <option value="4">Todas las Encuestas</option>
            </select>
          </div>                                                                
        </form>
        <br>   
