...
<html>
<head>
    <title>Editar usuario <?php echo $_GET['nombre'];?>- Modulo Usuarios</title>
    ...
    <script type="text/javascript" src="../../js/usuario_editar_validador.js" ></script>
  ...
  <div class="row">
    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="alert alert-success">
       La actualizaci&oacute;n se realiz&oacute; correctamente <a href="listado.php" class="alert-link">Lista de usuaios</a>.
     </div> 
     <?php $_SESSION['actualizar'] = 0?>
   <?php endif;?>
   
   <script> cargarListado('<?php echo $_GET['id'];?>')</script>     
   <div class="panel panel-default">
     <div class="panel-heading">
      Mofificar informaci&oacute;n de Usuario
    </div>
    <div class="panel-body">
      <form action="../../../../../indice_usuario.php" method="POST" class="form-horizontal">
        <input type="hidden" id="id_u" name="id_u" value="<?php echo $_GET['id'];?>"/>

    <div class="form-group ">
        <label class="control-label col-sm-3">Nombres</label>
        <div class="col-md-8">
          <input type="text" id="nombre" name="nombre_usuario_editar" placeholder="Introduce el nombre del nuevo usuario" class="form-control" tabindex="1"/>
        </div>
    </div>
    <div class="form-group ">
        <label class="control-label col-sm-3">Apellidos</label>
        <div class="col-md-8">
          <input type="text" id="apellidos" name="apellido_usuario_editar" placeholder="Introduce los nuevos apellidos" class="form-control" tabindex="2" />
        </div>
    </div>
    <div class="form-group ">
        <label class="control-label col-sm-3">Correo Electr&oacute;nico</label>
        <div class="col-md-8">
          <input type="text" id="email" name="correo" placeholder="Introduce el correo del nuevo usuario" class="form-control" tabindex="3" />
        </div>
    </div>
    <div class="form-group ">
        <label class="control-label col-sm-3">Contraseña</label>
        <div class="col-md-3">
          <input type="password" id="pass1" name="contrasena1" placeholder="Introduce una contraseña" class="form-control" tabindex="4" />
        </div>
        <label class="control-label col-sm-2">Repetir contraseña</label>
        <div class="col-md-3">
          <input type="password" id="pass2" name="contrasena2" placeholder="Introduce nuevamente una contraseña" class="form-control" tabindex="5"/>
        </div>
    </div>
    <hr/>
