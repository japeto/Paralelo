...
<html>
<head>
  <title>Usuarios - Modulo Usuarios</title>
  ...
  <script type="text/javascript" src="../../js/usuarios_consultar.js" ></script>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <div class="panel-body">
            <div>                            
              <input type="hidden" id="id_profile" name='id_perfil' value='<?php echo $_SESSION['usuario'];?>'>
            </div> 
            <div>
              <select class="selectpicker form-control"  id="id_consulta" data-live-search="true" data-style="btn btn-primary" data-size="5" tabindex="2">
                <option value="0">Seleccione la opci&oacute;n</option>
                <option value="1">Usuarios Activos</option>
                <option value="2">Usuarios No Activos</option>
                <option value="3">Todos los usuarios </option>
              </select>
            </div>                                                                
          </form>
          <div class="tablita1" id="answer">
          </div>                                                    
        </div>
      </div>
    </div>
