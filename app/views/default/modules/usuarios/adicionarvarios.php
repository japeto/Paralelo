...
<head>
  ...
  <script type="text/javascript" src="../../js/pines_validador.js" ></script>
  <script type="text/javascript" src="../../js/pines_cargar.js" ></script>                
...
<div class="panel-body">
  <form action="../../../../../indice_usuario.php" method="POST" class="addusuario">
    <div>                            
    ...
    <div>            
      Cantidad
      <input type="text" id="cantidad" placeholder="Introduce la cantidad de usuarios a generar" class="form-control" tabindex="1"/>
    </div>
    <br>
    <div class="col-sm-offset-5 col-sm-2">
      <a id="btnvariosusuarios" class="btn btn-primary boton" tabindex="3">Continuar <i class="fa  fa-chevron-right fa-fw"></i> </a>
    </div>
    <br>
    <hr/>
    <div class="table-responsive">
      <div id="tablausuarios" class="1table table-striped table-condensed">
      </div>
    </div>
    <br>
    <div class="col-sm-offset-5 col-sm-2">
      <a id="btnenviar" class="btn btn-primary boton" tabindex="4" style="display: none;"> <i class="fa  fa-save fa-fw"></i> Guardar</a>
    </div>
  </form>  
</div>
</div>
