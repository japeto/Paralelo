...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h2 class="page-header">Perf&iacute;l Administrador</h2>
      <div class="panel panel-default">
        <div class="panel-heading">
          Listado de Contraseñas de Acceso
        </div>
        <div class="panel-body">
          ...
          <div>
            <select class="selectpicker form-control"  id="id_consulta" data-width="" data-live-search="true" data-style="btn btn-primary" data-size="5" tabindex="1">
              ...
              <!-- <option value="5">Todas la contraseñas por Encuesta</option> -->
              ...
              <option value="10">Total Contraseñas por universidad por genero</option>
              <option value="11">Total Contraseñas por facultad por genero</option>
              <option value="12">Total Contraseñas por programa academico por genero</option>
            </select>
          </div>
          <div id="university">
        ...
        <div id="code">
          <input type='text' class="form-control" placeholder="ingrese el codigo" id='codigo_a_buscar' tabindex="5"/>
        </div>
        <div id="tipo_fin">
          <fieldset>
            <legend>Seleccione una opcion</legend>
            <p>
              <label id="radio1"><input type="radio" name="final" id="activo" value="1" />Finalizado</label>
              <label id="radio2"><input type="radio" name="final" id="no_activo" value="0" />No Finalizado</label>
              <label id="radio3"><input type="radio" name="final" id="no_activo" value="2" />No Utilizado</label>
              <label id="radio4"><input type="radio" name="final" id="no_activo" value="3" />Todos</label>
            </p>
          </fieldset>
        </div>
        <div id="gen">
          <fieldset>
            <legend>Seleccione una opcion</legend>
            <p>
              <label id="data1"><input type="radio" name="genero" id="M" value="1" />Masculino</label>
              <label id="data2"><input type="radio" name="genero" id="F" value="2" />Femenino</label>
              <label id="data3"><input type="radio" name="genero" id="O" value="3" />Todos</label>
            </p>
          </fieldset>
        </div>
        <center><a href="#" id="consulta" class="btn btn-primary boton" tabindex="6">Consultar</a> <button type="reset" id="clear" class="btn btn-primary " tabindex="6" >limpiar</button> </center>
        <br>
      </form>
