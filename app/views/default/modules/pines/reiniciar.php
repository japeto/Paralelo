...
<html>
<head>
  <title>Principal - Modulo Pines</title>
 ...
 <!--  <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css'>
  ...
  <script type="text/javascript" src="../../js/pines_reiniciar.js" ></script>
        ...
        <div class="sidebar-nav navbar-collapse">
          ...
          <li>
            ...
            <ul id="demo" class="nav nav-second-level">
              ...
              <li><a href="../usuarios/consulta.php">Activar/Desactivar</a></li>
            </ul>
          </li>
          <li>
    ...
    <div class="col-lg-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          Reiniciar Contraseñas de Acceso
        </div> 
        <div class="panel-body">
          <form>                   
            <div><center>Esta opcion permite borrar las contraseñas de acceso que se ha asignado previamente.</center></div><br>                                
            <div>
            ...
            <div><center><a href="#" id="restart" class="btn btn-primary" tabindex="3">Reiniciar</a></center></div>        
          </form>  
        </div>
      </div>
    </div>
