      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
         <form>
          ...
          <div>            
            Cantidad<input type="text" id="cantidad" placeholder="Introduce la cantidad de contraseñas a generar" class="form-control" tabindex="1"/>
          </div>
          <br>
          <div><center><a href="#" id="generar" class="btn btn-primary boton" tabindex="3">Generar</a></center></div>    
        </form>
      </div>   
    </div>
  </div>
