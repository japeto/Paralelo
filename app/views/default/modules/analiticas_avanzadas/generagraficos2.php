            ...
            <ul class="nav" id="side-menu">
              ...
              <li>
                ...
                <ul id="dem1" class="nav nav-second-level">
                 <li><a href="../analiticas/graficos2.php">Por pregunta</a></li>
                 <!-- <li><a href="../analiticas/consulta2.php">Exportar respuestas</a></li>  -->
                 <li><a href="../analiticas_avanzadas/graficos2.php">Resumen de encuesta</a></li>                                                                               
                 <li><a href="../analiticas_avanzadas/graficos_mineria2.php">Avanzada</a></li>
               </ul>
             </li>
             <li>
              ...
              <ul id="demp" class="nav nav-second-level">
               <li><a href="../analiticas_avanzadas/generagraficos2.php">Por pregunta</a></li>
          ...
          <div class="panel-body">
            <form action="../../../../../indice_encuestas.php" method="POST">                                                        
              ...
              <div><select class="selectpicker form-control" id="grafico_seleccionado" name="encuesta_a_graficar" data-width="" data-live-search="true" data-style="btn btn-primary" data-size="5" tabindex="1">                                                            
                ...
                <option value="4">Arbol</option>
                <option value="5">Burbuja</option>
              </select>
...
<div class="col-lg-6">
 <div class="panel panel-default">
  ...
  <div class="panel-body">
    <a id="zoomin" class="btn btn-xs btn-default" style="display:none;"><span class="glyphicon glyphicon-zoom-in"></span></a>
    <a id="zoomout" class="btn btn-xs btn-default" style="display:none;"><span class="glyphicon glyphicon-zoom-out"></span></a>
    <!-- <hr/>   -->
    <div id="grafica"></div>
  </div>
</div>
