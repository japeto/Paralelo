          ...
          <div class="sidebar-nav navbar-collapse">
            ...
            <li>
              ...
              <ul id="demo" class="nav nav-second-level">
                ...
                <li>
                  <a href="../usuarios/consulta.php">Activar o Desactivar</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul id="de" class="nav nav-second-level">
               <li><a href="../perfil/adicionar.php">Nuevo perf&iacute;l</a></li>
...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">Perf&iacute;l Administrador</h1>
    </div>
    </div>
    <div class="row">
      <div class="col-lg-12">
