...
<html>
<head>
  <title>Editar perfil <?php echo $_GET['nombre'];?>- Modulo Perfiles</title>
  ...
  <script type="text/javascript" src="../../js/perfiles_editar.js" ></script>
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
      ...
      <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
          ...
          <li>
            <a href="#" data-toggle="collapse" data-target="#de" class="active"><i class="fa  fa-tags fa-fw"></i> Perfiles<span class="fa arrow"></span></a>
            <ul id="de" class="nav nav-second-level">
             ...
             <li><a href="../perfil/consulta.php" class="active">Activar o Desactivar</a></li>
           </ul>
         </li>
         <li>
...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      ...
      <script>$(location).attr('href',"listado.php");</script>
    <?php endif;?>

    <div class="panel panel-default">
     <div class="panel-heading">
       Registrar un nuevo Perf&iacute;l
     </div>
     <div class="panel-body">
      <form action="../../../../../indice_usuario.php" method="POST">
        <input type="hidden" id="id_perfil" name="id_p" value="<?php echo $_GET['id'];?>"/>
        <div>
          <!-- <label>Perfil</label> -->
          <input type="text" id="perfil" name="nombre_perfil_editar" placeholder="Introduce el nombre del nuevo perfil" class="form-control" tabindex="2" value="<?php echo $_GET['perfil'];?>"/>
        </div><br>
        <div><center><button type="submit" class="btn btn-primary boton" tabindex="3">Cambiar</button></center></div>                                                                
      </form> 
    </div>  
  </div>
</div>
