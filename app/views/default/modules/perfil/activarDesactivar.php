    ...
    <div class="col-lg-12">
      ...
      <div class="panel panel-default">
        <div class="panel-body">              
          <?php echo $_GET['t'];?> el perfil <?php echo $_GET['nombre'];?> ?
          <?php if ($_GET['t'] == 'Desactivar'):?>
          <a href="../../../../../indice_usuario.php?id_perfil_desactivar=<?php echo $_GET['id'];?>" class="btn btn-primary">Si</a>
        <?php endif;?>
        <?php if ($_GET['t'] == 'Activar'):?>
        <a href="../../../../../indice_usuario.php?id_perfil_activar=<?php echo $_GET['id'];?>" class="btn btn-primary">Si</a>
      <?php endif;?>
