...
<?php $_SESSION['direccionar'] = 'admin'?>
...
<html>
	...
	<title>Crear Perfiles - Modulo Administrador Perfiles</title>
          ...
          <div class="sidebar-nav navbar-collapse">
            ...
            <li>
              ...
              <ul id="de" class="nav nav-second-level">
               <li><a href="../perfil/adicionar.php">Nuevo perfil</a></li><li>
...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      ...
      <?php $v = (int) $_SESSION['registro'];?>                                                    
      <?php  if ($v > 0): ?>
      <div class="alert alert-success">
       Se ha creado un nuevo perfil <a href="listado.php" class="alert-link">Lista de Perf&iacute;l</a>.
     </div>
   <?php endif;?>
   ...
   <div class="panel panel-default">
    ...
    <div class="panel-body">
      <form action="../../../../../indice_usuario.php" method="POST">
        <div>
          <input type="text" id="perfil" name="nombre_perfil" placeholder="Introduce el nombre del nuevo perfil" class="form-control" tabindex="2"/>
        </div>
        <br>
        <div><center><button type="submit" class="btn btn-primary boton" tabindex="3">Guardar</button></center></div>                                                                
      </form> 
    </div> 
  </div>
</div>
