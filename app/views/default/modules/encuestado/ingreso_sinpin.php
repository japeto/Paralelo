...
<html>
  ...
  <script type="text/javascript" src="../../js/encuestado_sinpin.js" ></script>
    ...
    <div id="main-wrapper" class="subpage">    
      <div class="container">                                    
        <div class="row">
          ...
          <?php $essinpin  = (int) $_SESSION['encuestado'];?>          
          <?php  if ($essinpin == 1): ?>
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form action="../../../../../indice_encuestado.php" method="POST">
                  ...
                  <div>
                    <input type="hidden" name="pin" placeholder="" class="form-control" tabindex="1" value="<?php echo $_SESSION['usuario_completo']['pin'];?>" />
                  </div>                                          
                  <br>
    <div class="form-group ">
        <div class="col-md-12">
          La encuesta que usted eligio es<br><br> <h2> <?php echo $_SESSION["nombre_encuesta"]['titulo'];?> </h2><br><br><b>¿Esta es la encuesta que desea contestar?</b>
          <hr/>
        </div>
        <div class="col-md-offset-4 col-md-4">
        <a id="aceptainsert" class="btn btn-primary" tabindex="1">Aceptar</a>
        <button type="submit" id="continuarinsert"class="btn btn-success" tabindex="2" disabled>Continuar >> </button>
        </div>
    </div>
                </form>   
              </div>
...
<!--             <div class="panel panel-default">
              <div class="panel-heading"> 
                Ingrese su Pin   <?php  echo $essinpin; ?>
              </div>
              <div class="panel-body">
                <form action="../../../../../indice_encuestado.php" method="POST">
                  <div><center><input type="hidden" name="id_encuesta" class="form-control" value="<?php echo $_SESSION['id_encuesta'];?>"/></center></div>
