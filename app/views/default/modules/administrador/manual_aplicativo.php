...
window.onload = function (){
  var success = new PDFObject({ url: "../manual/manual_usuarioAdministrador.pdf" }).embed("pdf");
};
</script>
  ...
  <div id="wrapper">
        ...
        <div class="sidebar-nav navbar-collapse">
          <ul class="nav" id="side-menu">
           <li class="current_page_item">
            <a href="../administrador/index.php" class="active"><i class="fa  fa-home fa-fw"></i> Principal Administrador</a>
          </li>
          ...
          <li>
            ...
            <ul id="demo" class="nav nav-second-level">
              <li>
                <a href="../usuarios/adicionar.php">Crear nuevo</a>
              </li>
              <li>
                <a href="../usuarios/listado_usuario.php">Actualizar</a>
              </li>
              <li>
                <a href="../usuarios/consulta.php">Activar/Desactivar</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul id="de" class="nav nav-second-level">
             ...
             <li><a href="../perfil/consulta.php">Activar/Desactivar</a></li>
           </ul>
         </li>
         <li>
   ...
   <ul class="nav navbar-top-links visible-xs">
    <li>
      ...
      <li><a  href='desconectado.php' title='Cerrar Sesi&aacute;n'><i class="fa  fa-sign-out fa-fw"></i> Cerrar Sesi&oacute;n </a></li>
    <?php else:?>
  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-md-6">
      <div class="panel panel-primary">
        ...
        <a href="manual_aplicativo.php" id="manual">
          <div class="panel-footer">
            <span class="pull-left">Ver Detalles</span>
            <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
            <div class="clearfix"></div>
      ...
      <div class="panel panel-red">
        <div class="panel-heading">
          <div class="row">
            ...
            <div class="col-xs-9 text-right">
              <div class="huge"></div>
              <div>Listado de Perfiles</div>
            </div>
          </div>
        </div>
        <a href="../perfil/listado.php">
          <div class="panel-footer">
            <span class="pull-left">Ver Detalles</span>
            <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
            <div class="clearfix"></div>
      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
        <!-- <object data="../Manual/ManualUsuario-Web.pdf" type="application/pdf" width="100%" height="100%">
          ...
          <div id="pdf"><a href="../manual/manual_usuarioAdministrador.pdf">Clic aqui para descargar PDF</a></div>
        </div>
      </div>
    </div>
  </div>
